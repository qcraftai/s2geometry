...
void EncodeS2PointVector(s2_absl::Span<const S2Point> points, CodingHint hint,
                         Encoder* encoder);
...
class EncodedS2PointVector {
 ...
 private:
  friend void EncodeS2PointVector(s2_absl::Span<const S2Point>, CodingHint,
                                  Encoder*);
  friend void EncodeS2PointVectorFast(s2_absl::Span<const S2Point>, Encoder*);
  friend void EncodeS2PointVectorCompact(s2_absl::Span<const S2Point>, Encoder*);
