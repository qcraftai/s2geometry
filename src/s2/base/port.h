...
// to define S2_ABSL_ATTRIBUTE_UNUSED to quiet particular instances of this warning
...
#define S2_ABSL_FUNC_PTR_TO_CHAR_PTR(func) (reinterpret_cast<char **>(func)[0])
#else  // not PPC or IA64
namespace s2_absl {
enum { kPlatformUsesOPDSections = 0 };
}  // namespace s2_absl
#define S2_ABSL_FUNC_PTR_TO_CHAR_PTR(func) (reinterpret_cast<char *>(func))
#endif  // PPC or IA64
#endif  // __cplusplus
