...
//                         s2_absl::make_unique<S2PolygonLayer>(&polygon),
//                         options);
//   S2Error error;
...
//       s2_absl::make_unique<s2builderutil::PointVectorLayer>(&points),
//       s2_absl::make_unique<s2builderutil::S2PolylineVectorLayer>(&polylines),
//       s2_absl::make_unique<S2PolygonLayer>(&polygon));
