...
// is successful.
S2_ABSLMUST_USE_RESULT bool MakePoint(s2_absl::string_view str, S2Point* point);

S2_ABSLDEPRECATED("Use MakePointOrDie.")
...
S2_ABSLMUST_USE_RESULT bool ParseLatLngs(s2_absl::string_view str,
                                       std::vector<S2LatLng>* latlngs);

S2_ABSLDEPRECATED("Use ParseLatLngsOrDie.")
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool ParsePoints(s2_absl::string_view str,
                                      std::vector<S2Point>* vertices);

S2_ABSLDEPRECATED("Use ParsePointsOrDie.")
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakeLatLng(s2_absl::string_view str, S2LatLng* latlng);
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakeLatLngRect(s2_absl::string_view str,
                                         S2LatLngRect* rect);

S2_ABSLDEPRECATED("Use MakeLatLngRectOrDie.")
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakeCellId(s2_absl::string_view str, S2CellId* cell_id);
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakeCellUnion(s2_absl::string_view str,
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakeLoop(s2_absl::string_view str,
                                   std::unique_ptr<S2Loop>* loop,
                                   S2Debug debug_override = S2Debug::ALLOW);

S2_ABSLDEPRECATED("Use MakeLoopOrDie.")
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakePolyline(s2_absl::string_view str,
                                       std::unique_ptr<S2Polyline>* polyline,
                                       S2Debug debug_override = S2Debug::ALLOW);

S2_ABSLDEPRECATED("Use MakePolylineOrDie.")
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakeLaxPolyline(
    s2_absl::string_view str, std::unique_ptr<S2LaxPolylineShape>* lax_polyline);

S2_ABSLDEPRECATED("Use MakeLaxPolylineOrDie.")
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakePolygon(s2_absl::string_view str,
                                      std::unique_ptr<S2Polygon>* polygon,
                                      S2Debug debug_override = S2Debug::ALLOW);

S2_ABSLDEPRECATED("Use MakePolygonOrDie.")
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakeVerbatimPolygon(
    s2_absl::string_view str, std::unique_ptr<S2Polygon>* polygon);

S2_ABSLDEPRECATED("Use MakeVerbatimPolygonOrDie.")
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakeLaxPolygon(
    s2_absl::string_view str, std::unique_ptr<S2LaxPolygonShape>* lax_polygon);

S2_ABSLDEPRECATED("Use MakeLaxPolygonOrDie.")
...
// As above, but does not S2_CHECK-fail on invalid input. Returns true if
// conversion is successful.
S2_ABSLMUST_USE_RESULT bool MakeIndex(
    s2_absl::string_view str, std::unique_ptr<MutableS2ShapeIndex>* index);

S2_ABSLDEPRECATED("Use MakeIndexOrDie.")
