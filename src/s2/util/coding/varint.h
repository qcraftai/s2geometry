...
class Varint {
 public:
  ...
  S2_ABSL_DEPRECATED("Use TwoValuesVarint::Encode32.")
  static void EncodeTwo32Values(string* s, uint32 a, uint32 b);
  S2_ABSL_DEPRECATED("Use TwoValuesVarint::Decode32.")
  static const char* DecodeTwo32Values(const char* ptr, uint32* a, uint32* b);
  S2_ABSL_DEPRECATED("Use TwoValuesVarint::Decode32WithLimit.")
