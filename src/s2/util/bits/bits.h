...
class Bits {
 public:
  ...
  static inline int CountOnes128(s2_absl::uint128 n) {
    return Bits::CountOnes64(s2_absl::Uint128High64(n)) +
           Bits::CountOnes64(s2_absl::Uint128Low64(n));
  }
  ...
  static inline int CountLeadingZeros128(s2_absl::uint128 n) {
    if (uint64 hi = s2_absl::Uint128High64(n))
      return Bits::CountLeadingZeros64(hi);
    return Bits::CountLeadingZeros64(s2_absl::Uint128Low64(n)) + 64;
  }
  ...
  static s2_absl::uint128 ReverseBits128(s2_absl::uint128 n);
  ...
  static int Log2Floor128(s2_absl::uint128 n);
  ...
  static int Log2FloorNonZero128(s2_absl::uint128 n);

  // Return ceiling(log2(n)) for positive integer n.  Returns -1 iff n == 0.
  static int Log2Ceiling(uint32 n);
  static int Log2Ceiling64(uint64 n);
  static int Log2Ceiling128(s2_absl::uint128 n);
  ...
  static int FindLSBSetNonZero128(s2_absl::uint128 n);
  ...
  static int FindMSBSetNonZero128(s2_absl::uint128 n) {
  ...
  static typename UnsignedType<T>::Type GetBits(const T src,
    ...
    const UnsignedT unsigned_src = s2_absl::bit_cast<UnsignedT>(src);
  ...
  static void SetBits(const typename UnsignedType<T>::Type value,
                      ...
                      T* const dest) {
    typedef typename UnsignedType<T>::Type UnsignedT;
    const UnsignedT unsigned_dest = s2_absl::bit_cast<UnsignedT>(*dest);
    S2_DCHECK_GT(sizeof(UnsignedT) * 8, offset);
    S2_DCHECK_GE(sizeof(UnsignedT) * 8, offset + nbits);
    ...
    *dest = s2_absl::bit_cast<T>(unsigned_result);
  }
...
inline int Bits::Log2Floor128(s2_absl::uint128 n) {
  if (uint64 hi = s2_absl::Uint128High64(n)) return 64 + Log2FloorNonZero64(hi);
  return Log2Floor64(s2_absl::Uint128Low64(n));
}

inline int Bits::Log2FloorNonZero128(s2_absl::uint128 n) {
  if (uint64 hi = s2_absl::Uint128High64(n)) return 64 + Log2FloorNonZero64(hi);
  return Log2FloorNonZero64(s2_absl::Uint128Low64(n));
}

inline int Bits::FindLSBSetNonZero128(s2_absl::uint128 n) {
  if (uint64 lo = s2_absl::Uint128Low64(n)) return Bits::FindLSBSetNonZero64(lo);
  return 64 + Bits::FindLSBSetNonZero64(s2_absl::Uint128High64(n));
}
...
inline s2_absl::uint128 Bits::ReverseBits128(s2_absl::uint128 n) {
  return s2_absl::MakeUint128(ReverseBits64(s2_absl::Uint128Low64(n)),
                           ReverseBits64(s2_absl::Uint128High64(n)));
}
