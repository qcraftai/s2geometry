...
inline s2_absl::uint128 gbswap_128(s2_absl::uint128 host_int) {
  return s2_absl::MakeUint128(gbswap_64(s2_absl::Uint128Low64(host_int)),
                           gbswap_64(s2_absl::Uint128High64(host_int)));
}
...
class LittleEndian {
 public:
  ...
  static s2_absl::uint128 FromHost128(s2_absl::uint128 x) { return x; }
  static s2_absl::uint128 ToHost128(s2_absl::uint128 x) { return x; }
  ...
  static s2_absl::uint128 FromHost128(s2_absl::uint128 x) { return gbswap_128(x); }
  static s2_absl::uint128 ToHost128(s2_absl::uint128 x) { return gbswap_128(x); }
  ...
  static s2_absl::uint128 Load128(const void* p) {
    return s2_absl::MakeUint128(
        ToHost64(UNALIGNED_LOAD64(reinterpret_cast<const uint64*>(p) + 1)),
        ToHost64(UNALIGNED_LOAD64(p)));
  }

  static void Store128(void* p, const s2_absl::uint128 v) {
    UNALIGNED_STORE64(p, FromHost64(s2_absl::Uint128Low64(v)));
    UNALIGNED_STORE64(reinterpret_cast<uint64*>(p) + 1,
                      FromHost64(s2_absl::Uint128High64(v)));
  }
  ...
  // set all to 0.
  static s2_absl::uint128 Load128VariableLength(const void* p, int len) {
    if (len <= 8) {
      return s2_absl::uint128(Load64VariableLength(p, len));
    } else {
      return s2_absl::MakeUint128(
...
class BigEndian {
 public:
  ...
  static void Store128(void* p, const s2_absl::uint128 v) {
    UNALIGNED_STORE64(p, FromHost64(s2_absl::Uint128High64(v)));
    UNALIGNED_STORE64(reinterpret_cast<uint64*>(p) + 1,
                      FromHost64(s2_absl::Uint128Low64(v)));
  }
  ...
  static s2_absl::uint128 Load128VariableLength(const void* p, int len) {
    if (len <= 8) {
      return s2_absl::uint128(
          Load64VariableLength(static_cast<const char*>(p), len));
    } else if (len < 16) {
      return s2_absl::MakeUint128(Load64VariableLength(p, len - 8),
                               Load64(static_cast<const char*>(p) + len - 8));
    } else {
      return s2_absl::MakeUint128(Load64(static_cast<const char*>(p)),
...
FROMHOST_TYPE_MAP(s2_absl::uint128, s2_absl::uint128);
...
class GeneralFormatConverter<EndianClass, float> {
 public:
  static typename tofromhost_value_type_traits<float>::int_type FromHost(
      float v) {
    return EndianClass::FromHost32(s2_absl::bit_cast<uint32>(v));
  }
  static typename tofromhost_value_type_traits<float>::int_type ToHost(
      float v) {
    return s2_absl::bit_cast<float>(
        EndianClass::ToHost32(s2_absl::bit_cast<uint32>(v)));
  }
};
...
class GeneralFormatConverter<EndianClass, double> {
 public:
  static typename tofromhost_value_type_traits<double>::int_type FromHost(
      double v) {
    return EndianClass::FromHost64(s2_absl::bit_cast<uint64>(v));
  }
  static typename tofromhost_value_type_traits<double>::int_type ToHost(
      double v) {
    return s2_absl::bit_cast<double>(
        EndianClass::ToHost64(s2_absl::bit_cast<uint64>(v)));
  }
};
...
template <class EndianClass>
class GeneralFormatConverter<EndianClass, s2_absl::uint128> {
 public:
  static typename tofromhost_value_type_traits<s2_absl::uint128>::int_type
  FromHost(s2_absl::uint128 v) {
    return EndianClass::FromHost128(v);
  }
  static typename tofromhost_value_type_traits<s2_absl::uint128>::int_type ToHost(
      s2_absl::uint128 v) {
...
inline float LoadFloat(const char* p) {
  return s2_absl::bit_cast<float>(EndianClass::ToHost32(UNALIGNED_LOAD32(p)));
}

template<typename EndianClass>
inline void StoreFloat(float value, char* p) {
  UNALIGNED_STORE32(p, EndianClass::FromHost32(s2_absl::bit_cast<uint32>(value)));
}

template<typename EndianClass>
inline double LoadDouble(const char* p) {
  return s2_absl::bit_cast<double>(EndianClass::ToHost64(UNALIGNED_LOAD64(p)));
}

template<typename EndianClass>
inline void StoreDouble(double value, char* p) {
  UNALIGNED_STORE64(p, EndianClass::FromHost64(s2_absl::bit_cast<uint64>(value)));
}
...
template <>
inline s2_absl::uint128 LittleEndian::Load<s2_absl::uint128>(const char* p) {
  return LittleEndian::Load128(p);
}

template <>
inline void LittleEndian::Store<s2_absl::uint128>(s2_absl::uint128 value, char* p) {
  LittleEndian::Store128(p, value);
}

template <>
inline s2_absl::uint128 BigEndian::Load<s2_absl::uint128>(const char* p) {
  return BigEndian::Load128(p);
}

template <>
inline void BigEndian::Store<s2_absl::uint128>(s2_absl::uint128 value, char* p) {
