...
#endif  // S2_ABSL_HAVE_STD_IS_TRIVIALLY_DESTRUCTIBLE
};
...
#ifdef S2_ABSL_HAVE_STD_IS_TRIVIALLY_CONSTRUCTIBLE
 private:
  ...
  static_assert(compliant || !std::is_trivially_default_constructible<T>::value,
                "Not compliant with std::is_trivially_default_constructible; "
                "Standard: true, Implementation: false");
#endif  // S2_ABSL_HAVE_STD_IS_TRIVIALLY_CONSTRUCTIBLE
};
...
#ifdef S2_ABSL_HAVE_STD_IS_TRIVIALLY_ASSIGNABLE
 private:
  static constexpr bool compliant =
  ...
  static_assert(compliant || !std::is_trivially_copy_assignable<T>::value,
                "Not compliant with std::is_trivially_copy_assignable; "
                "Standard: true, Implementation: false");
#endif  // S2_ABSL_HAVE_STD_IS_TRIVIALLY_ASSIGNABLE
};
