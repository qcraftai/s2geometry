...
S2_ABSLMUST_USE_RESULT inline s2_absl::string_view StripPrefix(
...
S2_ABSLMUST_USE_RESULT inline s2_absl::string_view StripSuffix(
...
S2_ABSLDEPRECATED("Use s2_absl::StripAsciiWhitespace() instead")
