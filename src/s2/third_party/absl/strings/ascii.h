...
S2_ABSLMUST_USE_RESULT inline string AsciiStrToLower(s2_absl::string_view s) {
  string result(s);
...
S2_ABSLMUST_USE_RESULT inline string AsciiStrToUpper(s2_absl::string_view s) {
  string result(s);
...
// given string_view.
S2_ABSLMUST_USE_RESULT inline s2_absl::string_view StripLeadingAsciiWhitespace(
...
// string_view.
S2_ABSLMUST_USE_RESULT inline s2_absl::string_view StripTrailingAsciiWhitespace(
    s2_absl::string_view str) {
...
// given string_view.
S2_ABSLMUST_USE_RESULT inline s2_absl::string_view StripAsciiWhitespace(
    s2_absl::string_view str) {
