...
S2_ABSL_MUST_USE_RESULT bool SimpleAtoi(s2_absl::string_view s, int_type* out);
...
S2_ABSL_MUST_USE_RESULT bool SimpleAtof(s2_absl::string_view str, float* value);
...
// See http://en.cppreference.com/w/c/string/byte/strtof for details about the
// allowed formats for `str`.
S2_ABSL_MUST_USE_RESULT bool SimpleAtod(s2_absl::string_view str, double* value);
...
S2_ABSL_MUST_USE_RESULT bool SimpleAtob(s2_absl::string_view str, bool* value);
...
template <typename int_type>
S2_ABSL_MUST_USE_RESULT bool safe_strtoi_base(s2_absl::string_view s, int_type* out,
                                           int base) {
