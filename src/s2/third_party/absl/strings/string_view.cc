...
#ifndef S2_ABSL_HAVE_STD_STRING_VIEW
...
#ifdef _MSC_VER
#define S2_ABSL_STRING_VIEW_SELECTANY __declspec(selectany)
#else
#define S2_ABSL_STRING_VIEW_SELECTANY
#endif

S2_ABSL_STRING_VIEW_SELECTANY
