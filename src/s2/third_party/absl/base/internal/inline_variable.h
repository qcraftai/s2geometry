...
////////////////////////////////////////////////////////////////////////////////
// Macro: S2_ABSL_INTERNAL_INLINE_CONSTEXPR(type, name, init)
//
// Description:
...
//   S2_ABSL_INTERNAL_INLINE_CONSTEXPR(size_t, variant_npos, -1);
//
...
#define S2_ABSL_INTERNAL_EXTERN_DECL(type, name) \
...
#define S2_ABSL_INTERNAL_INLINE_CONSTEXPR(type, name, init) \
  S2_ABSL_INTERNAL_EXTERN_DECL(type, name)                  \
  inline constexpr ::s2_absl::internal::identity_t<type> name = init

#ifdef __clang__
#undef S2_ABSL_INTERNAL_INLINE_CONSTEXPR
#define S2_ABSL_INTERNAL_INLINE_CONSTEXPR(type, name, init) \
  S2_ABSL_INTERNAL_EXTERN_DECL(type, name)                  \
...
//   appropriate place for pointer types, reference types, function pointer
//   types, etc..
#define S2_ABSL_INTERNAL_INLINE_CONSTEXPR(var_type, name, init)                  \
