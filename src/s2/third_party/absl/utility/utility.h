...
#else  // S2_ABSL_HAVE_STD_OPTIONAL
...
S2_ABSL_INTERNAL_INLINE_CONSTEXPR(in_place_t, in_place, {});

#endif  // S2_ABSL_HAVE_STD_OPTIONAL

#if defined(S2_ABSL_HAVE_STD_ANY) || defined(S2_ABSL_HAVE_STD_VARIANT)
...
#endif  // S2_ABSL_HAVE_STD_ANY || S2_ABSL_HAVE_STD_VARIANT
...
#endif  // S2_ABSL_HAVE_STD_VARIANT
